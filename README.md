...
[_Wathan, J., Burrows, A. M., Waller, B. M., & McComb, K. (2015). EquiFACS: the equine facial action coding system. PLoS one, 10(8), e0131738._](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0131738)
...
The EquiFACS Manual is freely available via the link below
[EquiFACS Manual](https://drive.google.com/file/d/1--gsUvebeaKpAxGgCoZRnu0f7uiCDmW0/view?usp=drive_link)

The associated training videos can be accessed here.
[Training/Example Videos](https://drive.google.com/drive/folders/1UP0NYpD2M_UTqwnYLMdAvLbqef0zXJ3X?usp=drive_link)
...
The test can be accessed here: [EquiFACS Test materials](https://drive.google.com/drive/folders/1fg-Aw1f0TDJijQShUlkerI-EmeQoursf?usp=drive_link)
